...
export default function CommentSection({ episodeId, currentTime, onTimeClick, videoPlayerRef }) {
    ...
    return (
        <Container className="comment-section mt-5">
                    ...
                    {Array.isArray(comments) && comments.length > 0 ? (
                        comments.map((comment) => (
                            <div key={comment.id} className="comment mb-3">
                                ...
                                <p className="comment-text">{renderCommentText(comment.commnentText)}</p>
                            </div>
                        ))
                    ) : (
                        <p>No comments yet.</p>
